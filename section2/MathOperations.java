public class MathOperations {
    public static void main(String[] args) {
        ...
        long starsInAndomeda = 1000000000000L;
        ...
        System.out.println("There are " + (starsInMilkyWay + starsInAndomeda) + " stars in the Milky Way and Andromeda galaxies.");
        ...
        System.out.println("The Andromeda Galaxy has " + (starsInAndomeda - starsInMilkyWay) + " more stars than the Milky Way.");

        System.out.println("Snape ended up removing marks. Ron actually scored " + (bonusMarks - testScore ) + " on his potions test");
